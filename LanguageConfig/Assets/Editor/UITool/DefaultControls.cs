...
namespace GameEdit
{
    ...
    public static class DefaultControls
    {
        ...
        private static void SetDefaultTextValues(LanguageText lbl)
        {
            ...
            //Font font = UnityEngine.Resources.Load<Font>("UI/Fonts/");
        ...
        public static GameObject CreateText(Resources resources)
        {
            ...
            LanguageText lbl = go.AddComponent<LanguageText>();
            lbl.text = "New Text";
